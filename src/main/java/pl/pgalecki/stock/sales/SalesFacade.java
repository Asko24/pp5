...
import pl.pgalecki.stock.sales.offerting.Offer;
import pl.pgalecki.stock.sales.offerting.OfferMaker;
import pl.pgalecki.stock.sales.ordering.InMemoryReservationStorage;
import pl.pgalecki.stock.sales.ordering.Reservation;
import pl.pgalecki.stock.sales.ordering.ReservationDetails;
import pl.pgalecki.stock.sales.payment.DummyPaymentGateway;
import pl.pgalecki.stock.sales.payment.PaymentGateway;
